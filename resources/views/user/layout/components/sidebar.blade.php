<div class="md:flex hidden md:w-1/4 h-screen bg-white border-r  ">
    ...
    <div id="navbar-default" class="mx-auto py-10 hidden md:block md:fixed md:px-16">
        ...
        <ul>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-semibold active:text-[#EC5252] "><a href="{{ route('ayo-mengenali-aku') }}">Ayo
                        Mengenali
                        aku</a></span>
            </li>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-semibold "><a href="/rs" class="">Rumah Sakit</span>
            </li>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-bold"><a href="/konsultasi">Konsultasi</span>
            </li>
