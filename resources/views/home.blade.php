...
<body class="">
    ...
    <div id="beranda" class="md:px-[120px] md:grid md:grid-cols-2 md:gap-6 pt-14 md:relative md:mt-12">
        <div class="md:w-[490px] text-center  lg:pt-20">
            <h5 class="text-[#FF0000] hidden    font-Poppins  md:ml-4 md:flex text-[16px] md:text-[18px]">
        ...
        <div class="grid grid-cols-4 gap-6 px-28 text-center py-10 font-Inter">
            <div class="">
                ...
                <div class="text-center flex">
                    <h1 id="counter" class="md:pl-[70px] text-[28px] ">393 </h1>
                    <p class="text-[28px]">K</p>
                </div>

                <h1 class="text-[18px] counter">2020</h1>
            </div>
            <div>
                <h1 class="text-[20px]">Total Cases</h1>
                <div class="text-center flex">
                    <h1 id="counterr" class="md:pl-[70px] text-[28px] ">443 </h1>
                    <p class="text-[28px]">K</p>
                </div>
                <h1 class="text-[18px]">2021</h1>
            </div>
            <div>
                <h1 class="text-[20px]">Total Cases</h1>
                <div class="text-center flex">
                    <h1 id="counterrr" class="md:pl-[70px] text-[28px] ">503 </h1>
                    <p class="text-[28px]">K</p>
                </div>
                <h1 class="text-[18px]">2022</h1>
            </div>
            <div>
    ...
    <div class="md:pt-24 md:grid md:grid-cols-3 md:gap-4 md:pl-32 md:pr-32 mb-32">
        ...
        <div>
            <img src="img/3.jpg" class="mt-10 md:mt-0" alt="" />
        </div>
    </div> --}}
        ...
        <div class="relative items-center w-full py-24 mx-auto md:px-12 lg:px-16 max-w-7xl">
            <div class="flex flex-wrap items-start justify-center w-full gap-4 px-5 mx-auto lg:px-0">
                <div class="w-full xl:w-1/3 lg:w-2/6 md:text-center lg:text-left">
                    <div id="harga" class="flex flex-col p-8 lg:p-0">
                        <strong class="mb-1 text-xs font-semibold tracking-widest text-blue-500 uppercase"> Safe
                            payments with Midtrans </strong>
                        <span class="mb-8 text-2xl font-bold text-neutral-600 tracking-relaxed lg:text-5xl"> Harga
                        </span>
                        <p class="mx-auto mb-4 text-xl font-light text-gray-500 text-opacity-70 lg:pr-10">Jika Anda
                            ingin menikmati fitur lebih Berlanganan lah di website kami sekarang</p>
                        <p class="mx-auto mb-2 text-xl font-light text-gray-500 text-opacity-70 lg:pr-10">Hanya dengan
                            10k anda bisa menikmati fitur kuis yang sangat interaktif dan menarik,cobalah sekarang juga
                        </p>
                    </div>
                </div>
                <div class="w-full xl:w-1/4 md:w-2/6">
                    <div class="relative flex flex-col h-full p-8 bg-gray-50 rounded-xl hover:border-white">
                        <span class="mb-4 text-base font-medium tracking-widest text-neutral-600 uppercase"> Free
                        </span>
                        <span class="flex items-center mb-8 text-base font-medium tracking-tight text-neutral-600"> Try
                            and decide. </span>
                        ...
                        <ul>
                            <li
                                class="flex items-center mt-8 mb-2 text-base font-medium tracking-tight text-neutral-600">
                                <span
                                ...
                                <strong>Fitur Chat Dokter</strong>
                            </li>
                            <li class="flex items-center mb-2 text-base font-medium tracking-tight text-neutral-600">
                                ...
                                <strong>3D simulasi </strong>
                            </li>
                            <li
                                class="flex items-center mb-2 text-base font-medium tracking-tight text-neutral-600 text-opacity-70">
                                <span
                        ...
                        <div class="mt-8">
                            <button
                                class="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 bg-white">Free</button>
                        </div>
                    </div>
                </div>
                <div class="w-full xl:w-1/4 md:w-2/6">
                    <div class="relative flex flex-col h-full p-8 bg-blue-600 rounded-xl hover:border-white">
                        ...
                        <div class="flex items-end text-3xl font-black leading-none text-white lg:text-4xl">
                            <span>
                                <span>Rp.10.000</span>
                                <del class="text-2xl font-normal text-white">Rp.100.000</del>
                            </span>
                        </div>
                        <ul>
                        ...
                        <div class="mt-8">
                            <form action="{{ url('/checkout') }}" method='POST'>
                                ...
                                <button type="button" onclick="requestCheckout()" id="pay-button"
                                    class="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 bg-white">Beli
                                    Rp.10.000</button>
                            </form>
    ...
    <div id="kontak" class="md:w-[800px] px-3 md:px-0 mx-auto mb-10 rounded-2xl"
        ...
        <form class="px-20 pt-10">
            ...
            <button type=""
                class="text-white mt-5 mb-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                <a href="mailto:ifa.aprillianto@gmail.com?subject = Feedback&body = Message">Send Message</a>
